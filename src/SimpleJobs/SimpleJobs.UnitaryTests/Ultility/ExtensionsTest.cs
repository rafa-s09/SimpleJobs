...
public class ExtensionsTest : TestBase
{
    ...
    [Theory]
    [InlineData("MÎt‡l HÎ‡d", "Metal Head")]
    [InlineData("ƒbcdef", "Abcdef")]
    [InlineData("", "")]
    ...
    [Theory]
    [InlineData(@"MÎt‡l!@#$%^&*()_+}{[]|:';<>,.?/~HÎ‡d", true, "Metal                           Head")]
    [InlineData(@"MÎt‡l!@#$%^&*()_+}{[]|:';<>,.?/~HÎ‡d", false, "MetalHead")]
    [InlineData("MÎt‡lHÎ‡d", true, "MetalHead")]
    [InlineData("MÎt‡lHÎ‡d", false, "MetalHead")]
    [InlineData("", true, "")]
    [InlineData("", false, "")]
